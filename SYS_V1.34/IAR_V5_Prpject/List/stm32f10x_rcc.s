...
//    List file    =  E:\DS0203\SYS_V1.34\IAR_V5_Prpject\List\stm32f10x_rcc.s /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
//  139   RCC->CFGR &= (u32)0xFF80FFFF;
        ...
        MVN      R1,#+8323072
        ANDS     R0,R1,R0
        LDR.N    R1,??DataTable16  ;; 0x40021000
        STR      R0,[R1, #+4]
//  140 
...
//  209   } while((HSEStatus == RESET) && (StartUpCounter != HSEStartUp_TimeOut));
        CBNZ     R0,??RCC_WaitForHSEStartUp_1
        LDR      R0,[SP, #+0]
        CMP      R0,#+1280
...
//  295   tmpreg = RCC->CFGR;
RCC_PLLConfig:
        LDR.N    R2,??DataTable13  ;; 0x40021004
        LDR      R3,[R2, #+0]
//  296 
...
//  342   tmpreg = RCC->CFGR;
RCC_SYSCLKConfig:
        LDR.N    R1,??DataTable13  ;; 0x40021004
        LDR      R2,[R1, #+0]
//  343 
...
RCC_GetSYSCLKSource:
        LDR.N    R0,??DataTable13  ;; 0x40021004
        LDR      R0,[R0, #+0]
        AND      R0,R0,#0xC
        BX       LR               ;; return
...
RCC_LSEConfig:
        LDR.N    R1,??DataTable12  ;; 0x40021020
        MOVS     R2,#+0
        STRB     R2,[R1, #+0]
//  580 
...
??RCC_GetFlagStatus_0:
        CMP      R1,#+2
        ITTEE    NE 
        LDRNE.N  R1,??DataTable16  ;; 0x40021000
        LDRNE    R1,[R1, #+36]
// 1006   {
// 1007     statusreg = RCC->BDCR;
        LDREQ.N  R1,??DataTable16  ;; 0x40021000
        LDREQ    R1,[R1, #+32]
// 1008   }
